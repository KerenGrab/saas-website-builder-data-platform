"""Canonical Part 9E data-quality rules.

Each SQL statement returns violating rows only.

Contract:
    0 rows  -> PASS
    >0 rows -> FAIL

These rules are intentionally read-only. Database-native PK/FK/UNIQUE/CHECK/
EXCLUSION constraints and trigger-enforced rules are not duplicated here.
"""

DQ_RULES = (
    {
        "rule_id": "DQ-01",
        "name": "Role periods contained in and continuously cover Membership periods",
    ...
    {
        "rule_id": "DQ-02",
        "name": "Every active Account is continuously covered by at least one active Owner",
        "domain": "Identity & Account",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-03",
        "name": "Account and Membership lifecycle events agree with period histories",
        "domain": "Identity & Account",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-04",
        "name": "Website publication, Live periods, and Address coverage are coherent",
    ...
    {
        "rule_id": "DQ-05",
        "name": "Page Access history is contiguous with no gaps",
        "domain": "Website & Structure",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-06",
        "name": "Content Item Access history is contiguous with no gaps",
        "domain": "Website & Structure",
        "violation_sql": """
            WITH ordered_access AS (
                SELECT
    ...
    {
        "rule_id": "DQ-07",
        "name": "Feature Enablement is continuously supported by Plan Entitlement",
        "domain": "Feature / Entitlement",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-08",
        "name": "Feature Enabled and Disabled events explain Enablement boundaries",
        "domain": "Feature / Entitlement",
        "violation_sql": """
            SELECT
    ...
    {
        "rule_id": "DQ-09",
        "name": "Product Behaviour actor, Account, and optional Website context are valid",
    ...
    {
        "rule_id": "DQ-10",
        "name": "Feature Used has Membership, Plan, Entitlement, and active Enablement",
        "domain": "Product Behaviour",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-11",
        "name": "Locked Feature Attempt occurs in one Plan context with no Entitlement",
        "domain": "Product Behaviour",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-12",
        "name": "Restricted Product Action Attempt is performed in active Viewer context",
        "domain": "Product Behaviour",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-13",
        "name": "Website Analytics Viewed is limited to active Owner or Editor context",
        "domain": "Product Behaviour",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-14",
        "name": "Invitation resolution and invitation-based registration are coherent",
        "domain": "Membership & Contributions",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-15",
        "name": "Member State history starts at registration and remains contiguous",
        "domain": "Membership & Contributions",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-16",
        "name": "Registration failures have a preceding start and Member logins have valid registration context",
        "domain": "Membership & Contributions",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-17",
        "name": "Every Comment has one posted event and every Rating has one given event",
        "domain": "Membership & Contributions",
        "violation_sql": """
            SELECT
    ...
    {
        "rule_id": "DQ-18",
        "name": "Session / Visitor Website consistency",
        "domain": "Audience",
        "violation_sql": """
            SELECT
                s.session_id,
    ...
    {
        "rule_id": "DQ-19",
        "name": "Every Session has exactly one Start and End in valid temporal order",
        "domain": "Audience",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-20",
        "name": "Every Session has exactly one Traffic Attribution",
        "domain": "Audience",
        "violation_sql": """
            SELECT
                s.session_id,
    ...
    {
        "rule_id": "DQ-21",
        "name": "Audience interactions stay inside Session time and Website context",
        "domain": "Audience",
        "violation_sql": """
            WITH session_stats AS (
                SELECT
    ...
    {
        "rule_id": "DQ-22",
        "name": "Visitor Member linkage and Session Member attribution are identity-consistent",
        "domain": "Audience",
        "violation_sql": """
            SELECT
    ...
    {
        "rule_id": "DQ-23",
        "name": "Every Signup Journey has one signup_started and one Acquisition Attribution",
        "domain": "Acquisition",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-24",
        "name": "Resulting Account is created exactly once and not before Signup Started",
        "domain": "Acquisition",
        "violation_sql": """
            WITH signup_stats AS (
                SELECT
    ...
    {
        "rule_id": "DQ-25",
        "name": "Subscription history starts Free and is continuous through Account lifetime",
        "domain": "Commercial",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-26",
        "name": "Billing Cycle periods are contained in exactly one Paid Plan interval",
        "domain": "Commercial",
        "violation_sql": """
            SELECT
    ...
    {
        "rule_id": "DQ-27",
        "name": "Subscription lifecycle events agree with Plan and Billing history",
        "domain": "Commercial",
        "violation_sql": """
    ...
    {
        "rule_id": "DQ-28",
        "name": "Account Closure is a hard boundary for Feature and Commercial history",
        "domain": "Cross-domain",
        "violation_sql": """
            WITH closures AS (
                SELECT
    ...
    {
        "rule_id": "DQ-29",
        "name": "Payment Succeeded occurs inside Paid Plan and Billing Cycle context",
        "domain": "Commercial",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-30",
        "name": "Support requester is an active Account Member at Opened time",
        "domain": "Support",
        "violation_sql": """
            SELECT
                e.event_id,
    ...
    {
        "rule_id": "DQ-31",
        "name": "Optional Support Website belongs to the Support Request Account",
        "domain": "Support",
        "violation_sql": """
            SELECT
                sr.support_request_id,
    ...
    {
        "rule_id": "DQ-32",
        "name": "Support lifecycle has exactly one Opened, at most one Resolved, and valid order",
        "domain": "Support",
        "violation_sql": """
